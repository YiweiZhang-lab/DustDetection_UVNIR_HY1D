...
%% 本论文方法
% % 加载r
load('data\KARDust_20211231\Rhor_385H.mat');
load('data\KARDust_20211231\Rhor_865.mat');
      
% % 加载RC
load('data\KARDust_20211231\Rhorc_385H.mat');
load('data\KARDust_20211231\Rhor_412.mat');
load('data\KARDust_20211231\Rhor_750.mat');
load('data\KARDust_20211231\Rhorc_865.mat');


% % 加载角度
load('data\KARDust_20211231\B3_Satellite_Zenith_Angle_rec.mat');
load('data\KARDust_20211231\B3_Sun_Zenith_Angle_rec.mat')
load('data\KARDust_20211231\B3_RAA_rec.mat')

load('data\KARDust_20211231\Satellite_Zenith_Angle_rec.mat');
load('data\KARDust_20211231\Sun_Zenith_Angle_rec.mat')
load('data\KARDust_20211231\RAA_rec.mat')

% % 加载经纬度
load('data\KARDust_20211231\Lon.mat');
load('data\KARDust_20211231\Lat.mat');
...
print('-dpng','-r1000',['UVDAI_KARDust_20211231','.png'])
...
print('-dpng','-r1000',['Class_UVDAI_KARDust_20211231','.png'])
...
print('-dpng','-r1000',['AAI_KARDust_20211231','.png']);
...
print('-dpng','-r1000',['Class_AAI_KARDust_20211231','.png'])
